...
export class SessionListComponent implements OnChanges {
    ...
    ngOnChanges(){
        ...
        this.sortBy === 'name' ? this.visibleSessions.sort(this.sortByName) : this.visibleSessions.sort(this.sortByVoters);
    ...
    sortByVoters(s1: ISession,s2: ISession){
    ...
    toggleVote(session: ISession){
        ...
        this.visibleSessions.sort(this.sortByVoters);
    }
